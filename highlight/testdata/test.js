    ...
    if (this.hasInitialMeasurements) {
      if (model.getAutoHeight()) {
        ...
        if (this.canScrollHorizontally())
          clientContainerHeight += this.getHorizontalScrollbarHeight();
        clientContainerHeight += "px";
      }
      if (model.getAutoWidth()) {
        style.width = "min-content";
        clientContainerWidth =
          this.getGutterContainerWidth() + this.getContentWidth();
        if (this.canScrollVertically())
          clientContainerWidth += this.getVerticalScrollbarWidth();
  ...
  renderDummyScrollbars() {
    if (this.shouldRenderDummyScrollbars && !this.props.model.isMini()) {
      ...
      if (this.hasInitialMeasurements) {
        ...
        horizontalScrollbarHeight = canScrollHorizontally
          ? this.getHorizontalScrollbarHeight()
          : 0;
        verticalScrollbarWidth = canScrollVertically
...
class LineNumberGutterComponent {
  ...
  shouldUpdate(newProps) {
    ...
    while (
      ...
      let oldTileBlockDecorations =
        oldProps.blockDecorations.get(oldTileStartRow);
      let newTileBlockDecorations =
  ...
  updateLines(oldProps, newProps) {
    ...
    while (
      ...
      if (oldScreenLineIndex >= oldScreenLinesEndIndex) {
        ...
        var oldScreenLineIndexInNewScreenLines =
  ...
  updateBlockDecorations(oldProps, newProps) {
    ...
    if (blockDecorations) {
      blockDecorations.forEach((newDecorations, screenLineId) => {
        var oldDecorations = oldProps.blockDecorations
