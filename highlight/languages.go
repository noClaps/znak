...
func parseLanguage(lang string) (tsh.Language, error) {
	switch lang {
	case "agda":
		highlights, err := queries.ReadFile("queries/agda/highlights.scm")
		if err != nil {
			return tsh.Language{}, err
		}
		return tsh.NewLanguage("agda", tree_sitter_agda.Language(), highlights, nil, nil), nil
	case "bash", "shellscript", "shell", "zsh", "sh":
		highlights, err := queries.ReadFile("queries/bash/highlights.scm")
		if err != nil {
			return tsh.Language{}, err
		}
		return tsh.NewLanguage("bash", tree_sitter_bash.Language(), highlights, nil, nil), nil
	case "c":
		...
		return tsh.NewLanguage("c", tree_sitter_c.Language(), highlights, injections, nil), nil
	case "cpp", "c++":
		...
		return tsh.NewLanguage("cpp", tree_sitter_cpp.Language(), highlights, injections, nil), nil
	case "css":
		highlights, err := queries.ReadFile("queries/css/highlights.scm")
		if err != nil {
			return tsh.Language{}, err
		}
		return tsh.NewLanguage("css", tree_sitter_css.Language(), highlights, nil, nil), nil
	case "go":
		...
		return tsh.NewLanguage("go", tree_sitter_go.Language(), highlights, injections, nil), nil
	case "haskell", "hs":
		highlights, err := queries.ReadFile("queries/haskell/highlights.scm")
		if err != nil {
			return tsh.Language{}, err
		}
		return tsh.NewLanguage("haskell", tree_sitter_haskell.Language(), highlights, nil, nil), nil
	case "html":
		...
		return tsh.NewLanguage("html", tree_sitter_html.Language(), highlights, injections, nil), nil
	case "java":
		...
		return tsh.NewLanguage("java", tree_sitter_java.Language(), highlights, injections, locals), nil
	case "javascript", "js", "jsx":
		...
		return tsh.NewLanguage("javascript", tree_sitter_javascript.Language(), highlights, injections, nil), nil
	case "jsdoc":
		highlights, err := queries.ReadFile("queries/jsdoc/highlights.scm")
		if err != nil {
			return tsh.Language{}, err
		}
		return tsh.NewLanguage("jsdoc", tree_sitter_jsdoc.Language(), highlights, nil, nil), nil
	case "json":
		highlights, err := queries.ReadFile("queries/json/highlights.scm")
		if err != nil {
			return tsh.Language{}, err
		}
		return tsh.NewLanguage("json", tree_sitter_json.Language(), highlights, nil, nil), nil
	case "ocaml":
		highlights, err := queries.ReadFile("queries/ocaml/highlights.scm")
		if err != nil {
			return tsh.Language{}, err
		}
		return tsh.NewLanguage("ocaml", tree_sitter_ocaml.LanguageOCaml(), highlights, nil, nil), nil
	case "ocaml_interface":
		highlights, err := queries.ReadFile("queries/ocaml/highlights.scm")
		if err != nil {
			return tsh.Language{}, err
		}
		return tsh.NewLanguage("ocaml_interface", tree_sitter_ocaml.LanguageOCamlInterface(), highlights, nil, nil), nil
	case "ocaml_type":
		highlights, err := queries.ReadFile("queries/ocaml/highlights.scm")
		if err != nil {
			return tsh.Language{}, err
		}
		return tsh.NewLanguage("ocaml_type", tree_sitter_ocaml.LanguageOCamlType(), highlights, nil, nil), nil
	case "php":
		...
		return tsh.NewLanguage("php", tree_sitter_php.LanguagePHP(), highlights, injections, nil), nil
	case "php_only":
		highlights, err := queries.ReadFile("queries/php/highlights.scm")
		if err != nil {
			return tsh.Language{}, err
		...
		return tsh.NewLanguage("php_only", tree_sitter_php.LanguagePHPOnly(), highlights, injections, nil), nil
	case "python", "py":
		highlights, err := queries.ReadFile("queries/python/highlights.scm")
		if err != nil {
			return tsh.Language{}, err
		}
		return tsh.NewLanguage("python", tree_sitter_python.Language(), highlights, nil, nil), nil
	case "regexp", "regex":
		highlights, err := queries.ReadFile("queries/regex/highlights.scm")
		if err != nil {
			return tsh.Language{}, err
		}
		return tsh.NewLanguage("regex", tree_sitter_regex.Language(), highlights, nil, nil), nil
	case "ruby", "rb":
		...
		return tsh.NewLanguage("ruby", tree_sitter_ruby.Language(), highlights, injections, nil), nil
	case "rust", "rs":
		...
		return tsh.NewLanguage("rust", tree_sitter_rust.Language(), highlights, injections, nil), nil
	case "scala":
		...
		return tsh.NewLanguage("scala", tree_sitter_scala.Language(), highlights, injections, nil), nil
	case "typescript", "ts":
		...
		return tsh.NewLanguage("typescript", tree_sitter_typescript.LanguageTypescript(), highlights, injections, nil), nil
	case "tsx":
		...
		return tsh.NewLanguage("tsx", tree_sitter_typescript.LanguageTSX(), highlights, injections, nil), nil
	}

	return tsh.Language{}, fmt.Errorf("Language not found: %s", lang)
}
